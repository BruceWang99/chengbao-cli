	...
	if(fs.existsSync(path.join(destDir, 'que.js'))){
		...
		await new Promise((resolve, reject)=>{
			...
			.use(async (files, metal, done)=>{
				// console.log(files, '<----');
				// 填充数据之前还需用户给答案
				// 解决问题require: https://stackoverflow.com/questions/42797313/webpack-dynamic-module-loader-by-require/53074814#53074814
				// const requireFunc = typeof __webpack_require__ === "function" ? __non_webpack_require__ : require;
				// const queList = requireFunc(path.join(destDir, './que.js'));
	    ...
	    // const targetPath = process.cwd() +'/'+ project
